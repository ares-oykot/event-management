            ...
            <div className="p-20 rounded-md bg-white h-full flex flex-col justify-around">
                ...
                <Link to={`/`}>
                    <button
                        ...
                        className="w-full text-white py-[2px] md:py-1 lg:py-5 text-[7px] md:text-[8px] lg:text-base rounded-sm  md:rounded lg:rounded-md md:mt-1 lg:mt-2 bg-[#2F80ED] hover:bg-[#3445ff] duration-200"
                    >
                        Go Back
                    </button>
                </Link>
